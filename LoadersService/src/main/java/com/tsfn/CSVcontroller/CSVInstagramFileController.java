...
import com.tsfn.CSVservice.CSVInstagramFileService;
...
public class CSVInstagramFileController {
    ...
    @GetMapping("/getAll")
	  public ResponseEntity<List<Instagram>> getAllInstagramFiles() {
	    try {
	    	List<Instagram> instagramFiles = csvService.getAllInstagramFiles();
